...
void DebugPrint() {
  ...
  Serial.print(yaw,0);                Serial.println(F(""));
  Serial.print(loop_frequency_hz,0);  Serial.print(F(", "));
  Serial.print(pitchPIDOutput,2);     Serial.print(F(", "));
  Serial.print(rollPIDOutput,2);      Serial.print(F(", "));
  Serial.print(motor1,1);             Serial.print(F(", "));
  Serial.print(motor2,1);             Serial.print(F(", "));
  Serial.print(motor3,1);             Serial.print(F(", "));
  Serial.print(motor4,1);             Serial.print(F(", "));
  Serial.print(boot_Seconds);         Serial.print(F(", "));
  
  Serial.print(hz_pitch_debug, 0);    Serial.print(F(", "));
  Serial.print(hz_roll_debug , 0);    Serial.println(F(" "));*/
}
...
void sendUARTOut() {
  Serial1.print("$");
  Serial1.print(filteredPitch,0);      Serial1.print(",");
  Serial1.print(filteredRoll,0);       Serial1.print(",");
  Serial1.print(yaw,0);                Serial1.print(",");
  Serial1.print(loop_frequency_hz,0);  Serial1.print('\n'); 
}
